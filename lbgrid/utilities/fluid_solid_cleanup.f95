SUBROUTINE fluid_solid_cleanup(fine)
!
...
!             if (i == 268 .and. j == 20 .and. k == 176) then
!              write(*,*) 'why why why?1',skip_counter,fluid_counter,null_counter,&
!                solid_counter,state(i,j,k,1)
!            end if
          END DO
        END DO
      END DO
...
!            if (i == 268 .and. j == 20 .and. k == 176) then
!              write(*,*) 'why why why?2',skip_counter,fluid_counter,null_counter,&
!                solid_counter,state(i,j,k,1)
!            end if
          END DO
        END DO
...
!            if (i == 268 .and. j == 20 .and. k == 176) then
!              write(*,*) 'why why why?3',skip_counter,fluid_counter,null_counter,&
!                solid_counter,state(i,j,k,1)
!            end if
          END DO
        END DO
...
!              WRITE(11,104)
            ...
            END IF
!            if (i == 268 .and. j == 20 .and. k == 176) then
!              write(*,*) 'why why why?4',skip_counter,fluid_counter,null_counter,&
!                solid_counter,state(i,j,k,1)
!            end if
          END DO
        END DO
...
!              WRITE(11,105)
            ...
            END IF
!            if (i == 268 .and. j == 20 .and. k == 176) then
!              write(*,*) 'why why why?5',skip_counter,fluid_counter,null_counter,&
!                solid_counter,state(i,j,k,1)
!            end if
          END DO
        END DO
...
!              WRITE(11,104)
            ...
            END IF
            if (i == 268 .and. j == 20 .and. k == 176) then
              write(*,*) 'why why why?6',skip_counter,fluid_counter,null_counter,&
                solid_counter,state(i,j,k,1)
            end if
          END DO
        END DO
